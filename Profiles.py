...
def load_profile(person):
    shared_file = person + "_Shared.txt"
    common_ancestor_file = person + "_Common.txt"


    if person == "Glyn":
        #shared_file = person + "_20230922a.txt"

        match_filter_list = ["aberlas", "AuntUnaManagedbySteamerpoint", "SallyAnneGale", "HelenReesHudsonManagedbyReesDinbych",
                             "gethngethn","AlanHughes","MaryCrawford",
                             "FrancesSandraKey",
        ...
        #    "patsobocienski",
            "BrianLonghurst",
            "DianaMelling",
            "GeraldineSharmanManagedbySteveCoe142",
            "JoshSando",     # cluster 3 , Colleen Toy
            "DonaldCohn",   # cluster 3 , Colleen Toy
            "SimonGray",
            "AnnHalden",
            "LeanneMepham"
        ]
      ...
      #                        "G.R.Managedbygemmaroberts50",
        ...
        match_filter_list5 = ["judio1343"]  # combines parent 1 and 2 , Jones with Buckle
...
#                              "ErinWilson", "ColleenOLeary", "AnnStoddard", "RebeccaBailey", "arwelwjones51",
                              "ErinWilson", "ColleenOLeary", "AnnStoddard", "arwelwjones51","RebeccaBailey","LouisaDavison","IforGlynLloyd",
                              "JuneMcLachlinManagedbyoschean", "IforGlynLloyd"]
        match_filter_list7 = ["GillianandGlynEvans", "D.H.ManagedbySEANALLEN","ElenLewis"]
       # match_filter_list8 = ["stevemcgarry189", "BrianLonghurst", "MalcolmSlade", "ClaireDayel-Baker", "judyrobinson"]
      #  match_filter_list8 = ["stevemcgarry189", "MalcolmSlade", "ClaireDayel-Baker", "judyrobinson"] # Slade also Essom
        match_filter_list8 = ["MalcolmSlade", "JaycobWilliams","JosephineKing","SallyAnneJohnson","ElizabethParry","Annfuller","JacquelineRichards"]
        match_filter_list9 = ["JanetBarnes"]
        match_filter_list10 = ["AmandaStanton", "JohnNolan573ManagedbySianShrewsbury"] #, "RayRutland65"]
        match_filter_list11 = [ "LadyDee","CarolynLucke","A.A.ManagedbyJasonLawson","SteveHarper","LauraTurner"]  # chromo 7 & 9 filter
        match_filter_list12 = ["InaBlancheParry","SionElganMetcalfe","GarethWilliams","LeonaCarter"]
        match_filter_list16 = ["KDee"]
        match_filter_list17 = ["MihiBell"]
        match_filter_list18 = ["JoanCourtney","MaryConnell","MindyFrench","KarlaStoker","jojoblueberry","drmiller48","hhhas", "WalterArthurCooperIII" ,"Melekika46", "dsberger120" ]
        ...
        match_filter_list.extend(match_filter_list11)
        match_filter_list.extend(match_filter_list12)
        match_filter_list.extend(match_filter_list16)
        match_filter_list.extend(match_filter_list17)

    if person == "Wayne":
        match_filter_list = [ "ag3754", "DavidLarsen", "sheilarobertsManagedbySheilaRoberts",
                         "BarbaraParryManagedbyGwendaParfitt", "aberlas","AuntUnaManagedbySteamerpoint","HelenReesHudsonManagedbyReesDinbych"]
#        match_filter_list2 = ["ThomasBennett","malcolmdavies656"]
    ...
    if person == "Gary":
        ...
        match_filter_list3 = ["aberlas", "AuntUnaManagedbySteamerpoint", "SallyAnneGale", "HelenReesHudsonManagedbyReesDinbych","gethngethn", \
    ...
    if person == "Sally":
        match_filter_list = ["AuntUnaManagedbySteamerpoint", "RobertFort", "LaurenRoberts", "DavidRobertsManagedbyLaurenRoberts","WynneOwens"]
    ...
    return  match_filter_list, shared_file, common_ancestor_file


def load_punters(person):

    Glyn_list = ["Glyn", "Glyn_16cM", "Glyn_15cM", "Glyn_14cM","Glyn_13cM", "Glyn_12cM", "Glyn_11cM", "Glyn_10cM",
    ...
    Sally_list = ["Sally","Sally_14cM", "Sally_13cM", "Sally_12cM", "Sally_11cM", "Sally_10cM", "Sally_9cM", "Sally_8cM", "Sally_7cM", "Sally_6cM", "Sally_L"]
    Una_list = ["Una", "Una_15cM", "Una_14cM", "Una_13cM", "Una_12cM", "Una_11cM", "Una_10cM", "Una_9cM", "Una_8cM",
                "Una_7cM", "Una_6cM", "Una_L"]
    Gary_list = ["Gary", "Gary_16cM", "Gary_15cM", "Gary_14cM", "Gary_13cM", "Gary_12cM", "Gary_11cM", "Gary_10cM",
                      "Gary_9cM", "Gary_8cM"]
    ...
    if person == "Elwyn":
        punters_file_list = [Elwyn_list, Wayne_list, Gary_list, Glyn_list, Sally_list, Helen_list]

    if person == "Sally":
        punters_file_list = [Sally_list,Una_list, Glyn_list, Wayne_list, Helen_list, Gary_list]

    if person == "Una":
        punters_file_list = [Una_list, Sally_list, Glyn_list, Wayne_list, Helen_list, Anji_list]

    if person == "Helen":
        punters_file_list = [Helen_list, Glyn_list, Una_list, Sally_list, Gary_list, Wayne_list]

    if person == "Anji":
        punters_file_list = [Anji_list, Glyn_list, Una_list, Sally_list, Gary_list, Wayne_list]

    if person == "Marg":
        punters_file_list = [Marg_list, Wayne_list, Gary_list, Elwyn_list, Glyn_list, Helen_list]


    return  punters_file_list
