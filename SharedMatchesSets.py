...
def main():
    ...
    if person == "Glyn":
        ...
        match_filter_list = ["aberlas", "UJonesManagedbySteamerpoint", "SallyAnneGale", "H.H.ManagedbyReesDinbych","gethngethn", \
                             ...
                             "G.R.Managedbygemmaroberts50", "ElizabethPritchard", "sheree8","AlwenaJames","judio1343"]
        match_filter_list2 = ["EricEngelhard","SimonGray", "JudithBuckle" , "NatalieRoberts_53%", "StevenRoberts","AmandaStanton"]
