...
class DNA_Result(object):
    ...
    def __init__(self, index=99999, offset = 0, who="", centimorgans=0, segments=0, people = "", keystring = "", kit_duplicate_check = "", kit = "wally"):
...
def get_data(word_list,index_offset , line_no, kit):
    new_word_dict = {}
    ...
    test_result = DNA_Result(int(line_no) , index_offset, new_word_dict["who"] , new_word_dict["cM"] , new_word_dict["segments"]
                             , new_word_dict["People"], new_word_dict["key_string"], kit_duplicate_check , kit)
...
def get_cousin_dict(kit, index_offset,  kit_key_list,duplicate_key_list, kit_who_list,kit_who_dict, dna_list, dna_list_index, duplicate_dict):
    ...
    for line in open(kit + '.txt'):
        ...
        kit_word_dict, test_result, kit_duplicate_check = get_data(word_list, index_offset , line_no, kit)
