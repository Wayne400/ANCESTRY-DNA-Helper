...
def get_shared_list(kit1, kit1_who_to_index_dict, list_of_filtered, file_path):
...
def main():
    kit1 = 'MyHeritage_Cousins'
    kit2 = 'MyHeritage_InCommon'
    kit3 = 'MyHeritage_Filtered'
    kit4 = 'MyHeritage_Chromosomes'
 ...
 #   print(list_of_filtered)
    ...
    list_of_shares = get_shared_list(kit2, kit1_who_to_index_dict, list_of_filtered, file_path)
